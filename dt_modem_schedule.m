function [x_hat, P, x_common, P_common, ledger, x_hats, Ps] = dt_modem_schedule(...
                        ...
                        delta_range, delta_azimuth, max_num_meas, x_navs_history, P_navs_history)
    ...
    if iter == ping_time
        ...
        if agent_share_times(agent) == iter % Agent's turn to share
            ...
            for b = 1:BLUE_NUM % Loop through all agents and share measurements
                ...
                [x_hat, P, x_common_debug, P_common_debug] = receive_buffer( ...
